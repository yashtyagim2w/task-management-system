    ...
    <div class="filters-container">
        <form id="filtersForm" class="filtersForm">
            ...
            <div class="filters-selection">
                ...
                <select name="active_status" id="active_filter">
                ...
                <select name="sort_by" id="sort_by">
                    ...
                    <option value="task_count">No. of Tasks</option>
                </select>
...
<div class="modal fade" id="createProjectModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="createProjectForm" method="POST" action="/admin/project/create">
        ...
        <div class="modal-content">
            ...
            <form id="editProjectForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Description</label>
                        <textarea id="edit_description" class="form-control" minlength="3" maxlength="1000" pattern="^.{3,1000}$" title="3-1000 chars." rows="3"></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Manager *</label>
                        <select id="edit_manager_id" class="form-select" required>
                            <option value="">Select Manager</option>
                            <?php foreach ($managers as $manager) { ?>
                                <option value="<?= $manager['id'] ?>">
            ...
            <div class="modal-body">
                ...
                <div class="card mb-3">
                    <div class="card-body py-2">
                        ...
                        <span class="ms-3"><strong>Manager:</strong> <span id="assign_manager_name"></span></span>
                    </div>
                </div>
...
<script type="module" src="/assets/js/admin/projects.js"></script>