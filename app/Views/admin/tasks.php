        ...
        <div class="filters-selection">
            ...
            <select id="projectSelect">
                ...
                <?php foreach ($projects as $project): ?>
                    <option value="<?= $project['id'] ?>" data-manager-id="<?= $project['manager_id'] ?>"><?= htmlspecialchars($project['name']) ?></option>
                <?php endforeach; ?>
            </select>
            ...
            <form id="createTaskForm">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" minlength="3" maxlength="255"
                            pattern="(?=.*[A-Za-z0-9])[A-Za-z0-9 _()\-]{3,255}"
                            title="3-255 chars. Letters, numbers, spaces, -, _, () only." required>
                    </div>
                    <div class="mb-3">
